...
import {
  BROWN, capitalize, CDN_LINK, inlineCode,
} from './utils';
...
export class MiningPick extends Item {
  ...
  miningAnimationUrl = `${CDN_LINK}574852830125359126/882898676111003658/mining.gif`;
...
export abstract class Stone extends Item {
  ...
  combineAnimationUrl = `${CDN_LINK}574852830125359126/884774042899447838/ezgif.com-gif-maker.gif`;
...
export abstract class Gem extends Stone {
  ...
  show(count: number) {
    ...
    if (count !== -1) embed.addField('Count', count, true);
